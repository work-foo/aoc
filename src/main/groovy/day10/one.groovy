...
//def resource = manager.getInputStream('day10/test3') /* 0099811188827773336446555566 */ ;def expected = 1
...
record Node(int down, int right, int value) {}
...
def traverser = Traverser.forGraph { Node n ->
